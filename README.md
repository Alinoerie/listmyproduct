# ListMyProduct (`cursorlistmyproduct`)
...
5. Google OAuth redirect URIs:
   ...
   - Production: `https://listmyproduct.vercel.app/api/auth/callback/google`
...
1. [Install Inngest](https://vercel.com/marketplace/inngest) on the **listmyproduct** Vercel project.
