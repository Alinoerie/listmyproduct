...
async function main() {
  console.log(`\nListMyProduct API smoke test → ${BASE_URL}\n`);
  ...
  const imageUrl =
    ...
    "https://res.cloudinary.com/diwmwicr8/image/upload/v1779813471/listmyproduct/cmplgj5gf0000frp959ltv695/uploads/bh3gx6oxvfvxy4e9qnlf.jpg";
