...
async function main() {
  console.log(`\nListMyProduct E2E readiness — ${TEST_EMAIL}\n`);
  ...
  if (!inngestOk) {
    console.log(
      "  → Install: https://vercel.com/marketplace/inngest — connect listmyproduct, redeploy production"
    );
  }
  ...
  if (process.env.NODE_ENV === "development") {
    ...
    console.log("Production smoke: SMOKE_BASE_URL=https://listmyproduct.vercel.app pnpm test:smoke:prod");
  }
  console.log("");
}
