...
export const metadata: Metadata = {
  title: "Book a Demo — ListMyProduct",
  description:
    "Book a 30-minute ListMyProduct demo. See how AI turns your ecommerce catalog into listing images and copy that improve visibility and conversion.",
  openGraph: {
    title: "Book a ListMyProduct Demo",
  ...
  return (
    <MarketingPageShell className="bg-[var(--muted)]/20">
      <MarketingHero
        ...
        title="See ListMyProduct on your catalog"
