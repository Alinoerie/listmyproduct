...
export const metadata: Metadata = {
  title: "Free Ecommerce Optimization Guide Pack — ListMyProduct",
  description:
  ...
  return (
    <MarketingPageShell>
      <MarketingHero
        ...
        description="Practical playbooks from ListMyProduct — built for sellers who need catalog scale without losing brand voice."
        actions={
          <>
      ...
      <MarketingInkBand
        title="Guides show the plan — ListMyProduct runs the creative"
