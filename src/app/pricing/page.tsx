      ...
      <main className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        ...
        <section className="mt-20">
          ...
          <div className="mx-auto mt-8 max-w-3xl space-y-4">
            ...
            <details className="group rounded-xl border border-[var(--border)]">
              <summary className="flex cursor-pointer items-center justify-between px-6 py-4 font-medium">
                Can I use ListMyProduct for free?
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="transition-transform group-open:rotate-180">
                  <polyline points="6 9 12 15 18 9"/>
                </svg>
              </summary>
            ...
            <details className="group rounded-xl border border-[var(--border)]">
              ...
              <div className="px-6 pb-4 text-sm text-[var(--muted-fg)]">
                Yes, ListMyProduct supports export to Amazon EU and UK marketplaces. Generate images and copy, then export directly to your listings.
              </div>
            </details>
          </div>
        </section>
        ...
        <section className="mt-20 text-center">
          <p className="text-[var(--muted-fg)]">Questions? Email us at <a href="mailto:hello@listmyproduct.com" className="text-[var(--accent)] hover:underline">hello@listmyproduct.com</a></p>
        </section>
      </main>
    </div>
  );
