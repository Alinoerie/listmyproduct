...
export const metadata: Metadata = {
  title: "Privacy Policy — ListMyProduct",
  description: "How ListMyProduct collects, uses, and protects your data.",
};
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 md:py-24">
        ...
        <div className="prose prose-neutral mt-10 max-w-none space-y-8 text-[var(--foreground)] [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-normal [&_p]:leading-relaxed [&_p]:text-[var(--muted-fg)] [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5 [&_ul]:text-[var(--muted-fg)]">
          <section>
            <h2>Overview</h2>
            <p>
              ListMyProduct (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) is an AI listing studio for marketplace sellers. This policy explains
          ...
          <section>
            ...
            <p>
              ListMyProduct is the data controller for all personal data processed in connection with our service.
            ...
            <ul>
              <li><strong>Entity:</strong> ListMyProduct Ltd.</li>
              <li><strong>Contact:</strong> <Link href="mailto:dpo@listmyproduct.app" className="text-[var(--accent)] underline-offset-2 hover:underline">dpo@listmyproduct.app</Link></li>
              <li><strong>Address:</strong> ListMyProduct Ltd., [Registered Address], [City], [Country]</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                ...
                request the free ecommerce guide pack, used to send the resource and occasional ListMyProduct updates.
              </li>
              <li>
                <strong className="text-[var(--foreground)]">Demo bookings</strong> — name, email, company, catalog
                details, and preferred time when you book a ListMyProduct demo.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              All processors used by ListMyProduct are either located in the EEA or have been verified as providing
          ...
          <section>
            ...
            <p>
              To exercise any rights, email <Link href="mailto:support@listmyproduct.app" className="text-[var(--accent)] underline-offset-2 hover:underline">support@listmyproduct.app</Link> or{" "}
              <Link href="mailto:dpo@listmyproduct.app" className="text-[var(--accent)] underline-offset-2 hover:underline">dpo@listmyproduct.app</Link>.
          ...
          <section>
            ...
            <p>
              ...
              <Link href="mailto:dpo@listmyproduct.app" className="text-[var(--accent)] underline-offset-2 hover:underline">
                dpo@listmyproduct.app
              </Link>
          ...
          <section>
            ...
            <p>
              ...
              <Link href="mailto:support@listmyproduct.app" className="text-[var(--accent)] underline-offset-2 hover:underline">
                support@listmyproduct.app
              </Link>{" "}
              or{" "}
              <Link href="mailto:dpo@listmyproduct.app" className="text-[var(--accent)] underline-offset-2 hover:underline">
                dpo@listmyproduct.app
