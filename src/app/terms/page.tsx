...
export const metadata: Metadata = {
  title: "Terms of Service — ListMyProduct",
  description: "Terms governing use of the ListMyProduct listing studio.",
};
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 md:py-24">
        ...
        <div className="prose prose-neutral mt-10 max-w-none space-y-8 text-[var(--foreground)] [&_h2]:font-serif [&_h2]:text-2xl [&_h2]:font-normal [&_p]:leading-relaxed [&_p]:text-[var(--muted-fg)] [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5 [&_ul]:text-[var(--muted-fg)]">
          <section>
            <h2>Agreement</h2>
            <p>
              By accessing ListMyProduct, you agree to these Terms. If you do not agree, do not use the service. We may
          ...
          <section>
            ...
            <p>
              ListMyProduct helps sellers create marketplace listing images and copy using AI. Outputs are assistive —
