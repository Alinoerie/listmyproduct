...
export function ShopifyIntegration({ userId, userEmail }: ShopifyIntegrationProps) {
  ...
  return (
    <StudioPageShell
      ...
      title="Shopify App"
      description="ListMyProduct directly inside your Shopify admin — generate and publish listings without leaving Shopify."
    >
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3">
                <CardTitle className="text-base">Install ListMyProduct in your Shopify store</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm text-[var(--muted-fg)]">
                Install ListMyProduct directly in your Shopify store. Generate professional product images and 
              ...
              <p className="text-xs text-[var(--muted-fg)] text-center">
                Coming soon — ListMyProduct inside your Shopify admin
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ul className="space-y-3 text-sm">
                {[
                  "ListMyProduct accessible from your Shopify admin sidebar",
