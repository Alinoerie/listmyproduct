...
export function ZapierIntegration({ userId, webhookUrl, userEmail }: ZapierIntegrationProps) {
  ...
  return (
    <StudioPageShell
      ...
      title="Zapier & Make"
      description="Automate your workflow with webhooks — trigger ListMyProduct from Zapier, Make (Integromat), and other no-code platforms."
    >
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-[var(--muted-fg)]">
                Use this unique webhook URL to trigger ListMyProduct actions from Zapier, Make, or any 
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-[var(--muted-fg)]">
                When a ListMyProduct action completes (e.g., listing generated, images created), your webhook 
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <dl className="space-y-2 text-sm">
                    {[
                      { field: "productId", type: "string", desc: "Unique product identifier in ListMyProduct" },
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-[var(--muted-fg)]">
                ...
                ListMyProduct to 5,000+ apps without writing any code. Join the waitlist to be notified.
              </p>
