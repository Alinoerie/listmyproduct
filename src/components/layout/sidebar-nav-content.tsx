...
import { ListMyProductLogo, ListMyProductWordmark } from "@/components/brand/listmyproduct-logo";
    ...
    <>
      {showHeader ? (
        <div className={cn("border-b border-[var(--border)] p-4", collapsed && "px-3")}>
          ...
          >
            {collapsed ? (
              <ListMyProductLogo size={44} />
            ) : (
              <ListMyProductWordmark size={44} textClassName="text-lg" />
            )}
          </Link>
