    ...
    <div className="mx-auto max-w-xl rounded-3xl border border-[var(--border)] bg-[var(--card)] p-6 shadow-[var(--shadow-lg)] md:p-8">
      ...
      {step === 1 ? (
        <>
          ...
          <h1 className="mt-3 font-serif text-2xl md:text-3xl">Book your ListMyProduct demo</h1>
          <p className="mt-3 text-sm leading-relaxed text-[var(--muted-fg)] md:text-base">
            I will show you how ListMyProduct turns one product photo into research-backed gallery images and listing
