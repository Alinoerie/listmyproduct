  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-gradient-to-br from-[var(--ink)] via-[#1e1b4b] to-[var(--teal)]/40 p-6 text-white shadow-[var(--shadow-lg)]">
      ...
      <div className="relative">
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[var(--accent-soft)]">ListMyProduct</p>
            ...
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-[var(--muted-fg)]">
                  ...
                  ListMyProduct handles the image + copy generation when you&apos;re ready to execute.
                </p>
              </div>
              <Button asChild variant="outline" className="rounded-xl">
                <Link href="/login">Start free in ListMyProduct</Link>
              </Button>
            </div>
