      ...
      <div className="mx-auto max-w-6xl space-y-12">
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 font-serif text-3xl md:text-4xl">
            ListMyProduct vs WizStudio, Pixii, Photoroom, and generic AI
          </h2>
          <p className="mt-4 text-white/70">
            Most tools do one thing — images or copy or catalog sync. ListMyProduct does all three from a single product photo, before the listing even exists.
          </p>
        </div>
        ...
        <p className="text-xs text-white/30">
          Competitor data based on publicly available pricing and feature pages as of 2026. ⚠ = partial support. ListMyProduct data reflects live product.
        </p>
      </div>
    </section>
  );
