...
const TESTIMONIALS: Testimonial[] = [
  {
    quote:
      "ListMyProduct cut our listing time from 3 weeks to 20 minutes. The A+ modules alone saved us €2,000 per product.",
    author: "Sarah M.",
  ...
  {
    quote:
      "We used to spend €800/month on copywriters for our 200-product catalog. Now one person handles it in ListMyProduct. The ROI is insane.",
    author: "Marco B.",
  ...
  {
    quote:
      "The AI actually understands Amazon's style guide. Our listings score 40% higher in the grader after rebuilding with ListMyProduct.",
    author: "Lena K.",
