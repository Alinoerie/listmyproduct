    ...
    <div className="space-y-8">
      ...
      {error && error !== "INSUFFICIENT_CREDITS" ? (
        <div className="rounded-xl border border-[var(--error-border)] bg-[var(--error-bg)] px-4 py-3 text-sm text-[var(--error)]">
          <PipelineErrorMessage message={toSellerPipelineError(error)} supportSubject="ListMyProduct A+ generation issue" />
        </div>
      ) : null}
      ...
      {pollTimedOut ? (
        <div className="rounded-xl border border-[var(--error-border)] bg-[var(--error-bg)] px-4 py-3 text-sm text-[var(--error)]">
          <PipelineErrorMessage
            ...
            supportSubject="ListMyProduct A+ generation timeout"
          />
        </div>
      ) : null}
