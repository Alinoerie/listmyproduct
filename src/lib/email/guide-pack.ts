...
<html>
  <body style="font-family: system-ui, sans-serif; line-height: 1.5; color: #111827; max-width: 520px; margin: 0 auto; padding: 24px;">
    <p style="font-size: 13px; font-weight: 600; letter-spacing: 0.08em; text-transform: uppercase; color: #6366F1; margin: 0 0 8px;">ListMyProduct guide pack</p>
    ...
    <p style="margin: 24px 0 0; padding-top: 24px; border-top: 1px solid #e5e7eb; color: #4b5563;">
      ...
      <a href="${params.studioUrl}" style="color: #6366F1;">Start free in ListMyProduct →</a>
    </p>
  </body>
</html>`;
}
