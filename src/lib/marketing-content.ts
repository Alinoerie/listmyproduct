...
export const EXPLORE_LINKS = [
  ...
  { href: "/gallery", title: "Sample gallery", desc: "Real outputs from ListMyProduct runs" },
  { href: "/marketplaces", title: "EU & Bol.com", desc: "Marketplace positioning and calculator" },
  { href: "/compare", title: "Why ListMyProduct", desc: "Launch before you list vs catalog-sync & ASIN tools" },
