...
export const PRICING_FAQ = [
  {
    ...
    a: "Credits are ListMyProduct's only currency. Each image or copy run shows the exact total before you confirm. You only spend credits when you generate — not when you browse, edit prompts, or export finished work.",
  },
  {
  ...
  },
  {
    ...
    a: "You do. ListMyProduct generates listing images and copy for your products — use them on Amazon, Bol.com, Shopify, and other channels you sell on.",
  },
  {
